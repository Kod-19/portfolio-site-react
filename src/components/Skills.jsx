...
const Skills = () => {
  return (
    <div id='skills' className='text-white flex flex-col items-center sm:gap-7 max-sm:pb-7 py-20 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30'>
      <h3 className='text-3xl sm:text-3xl lg:text-5xl'>How can I help?</h3>
      ...
      <div className='grid grid-cols-4 max-sm:grid-cols-2 w-full pb-20 gap-6 items-center lg:max-w-lg max-sm:pt-20 pt-20'>
